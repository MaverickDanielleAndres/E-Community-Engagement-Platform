...
export class EmailVerificationService {
  ...
  static async sendVerificationEmail(email: string): Promise<{ success: boolean; message: string; canResend?: boolean }> {
    try {
      ...
      // Send email using Resend with proper domain
      const emailResult = await resend.emails.send({
        from: 'E-Community <noreply@resend.dev>', // Use proper Resend domain
      ...
      console.log('Resend response:', emailResult) // Debug log
