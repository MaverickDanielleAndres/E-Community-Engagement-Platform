// @/app/main/admin/polls/page.tsx - Updated with full functionality
'use client'
...
import { PlusSquare, Eye, Trash2 } from 'lucide-react'
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        {polls.length === 0 && !loading ? (
          <EmptyState
            ...
            onAction={() => router.push('/main/admin/polls/create')}
          />
        ) : (
          <DataTable
            data={polls}
