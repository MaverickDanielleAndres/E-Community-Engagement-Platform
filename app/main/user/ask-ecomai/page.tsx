...
export default function UserAskEComAI() {
  ...
  return (
    <div>
      ...
      {/* Chat Input - Outside container to overstep */}
      <form onSubmit={handleSubmit} className="flex space-x-2 px-4 py-4 max-w-4xl mx-auto flex-wrap sm:flex-nowrap">
        <input
          type="text"
          value={input}
          ...
          className={`flex-grow min-w-0 px-4 py-2 rounded-lg border ${
            isDark
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mt-2 sm:mt-0 sm:ml-2"
        >
